...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default="/home/v-boli4/teamdrive/msrashaiteamdrive/data")
    ...
    wandb.init(project='iib', entity='drluodian')
    ...
    if args.hparams_path:
        with open(args.hparams_path, 'r') as fp:
            hparams.update(json.load(fp))
